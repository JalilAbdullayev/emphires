...
class ServiceController extends Controller {
    ...
    public function index(): View {
        $langs = [
            ['code' => 'en', 'url' => '/en/admin/services'],
            ['code' => 'az', 'url' => '/admin/xidmetler'],
    ...
    public function create(): View {
        $langs = [
            ['code' => 'en', 'url' => '/en/admin/services/create'],
            ['code' => 'az', 'url' => '/admin/xidmetler/yarat'],
    ...
    public function edit(int $id): View {
        $langs = [
            ['code' => 'en', 'url' => '/en/admin/services/edit/' . $id],
            ['code' => 'az', 'url' => '/admin/xidmetler/redakte/' . $id],
