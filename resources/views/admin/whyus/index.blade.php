        ...
        <table id="myTable" class="table table-striped border">
            ...
            <tbody id="sortable-tbody" data-route="{{ route('admin.whyus.sort') }}">
                @foreach ($advantages as $advantage)
                    <tr id="{{ $advantage->id }}" data-id="{{ $advantage->id }}" data-order="{{ $advantage->order }}">
                        <td>
                            {{ $advantage->title }}
                        </td>
                        <td>
                            <div class="form-check form-switch">
                                <input type="checkbox" @checked($advantage->status) class="form-check-input" />
                            </div>
                        </td>
                        <td>
                            {!! $advantage->icon !!}
                        ...
                        <td>
                            <a href="{{ route('admin.whyus.edit_' . session('locale'), $advantage->id) }}"
