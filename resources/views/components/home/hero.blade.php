                ...
                <div class="glide__slide relative">
                    ...
                    <div class="absolute top-96 left-10 xl:left-48 right-0">
                        ...
                        <div class="text-white mt-8 flex items-center gap-12">
                            <a href=""
                                class="font-['Nunito'] leading-6 font-extrabold border-2 border-white py-4 px-12 rounded-md uppercase text-sm hover:bg-[#0AADEB] duration-500 hover:border-[#00ADEB] text-white [&>p]:mb-0">
                                {!! $slide->button_text !!}
                            </a>
