<section class="py-12 bg-primary bg-no-repeat bg-[70%]"
    ...
    <div class="px-7 col-4 items-center">
        ...
        <a href="{{ route('contact_' . session('locale')) }}"
           class="uppercase text-white py-4 lg:px-11 text-center border-2 border-white rounded-md hover:bg-white hover:text-[#0C121D] font-extrabold font-nunito-sans tracking-wider md:w-fit [&>*]:mb-0 [&>*]:inline]">
